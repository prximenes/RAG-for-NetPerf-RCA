---
                {
  "source": "web",
  "label": "qemu-virtio-net-failover",
  "url": "https://www.qemu.org/docs/master/system/virtio-net-failover.html",
  "description": "Virtio-net standby/failover behavior; relevant to virtio troubleshooting and migration",
  "license": "QEMU documentation (see site for license)",
  "collected_at": "2025-12-15T17:15:28.814715+00:00"
}
                ---
                # QEMU Virtio-net Standby (net_failover)

                QEMU virtio-net standby (net_failover) — QEMU  documentation
            QEMU
Contents:
- About QEMU
- System Emulation
...
```
-devicevirtio-net-pci,netdev=hostnet1,id=net1,mac=52:54:00:6f:55:cc,bus=root2,failover=on
```
With the parameter
```
failover=on
```
 the VIRTIO_NET_F_STANDBY feature will be enabled.
```
-devicevfio-pci,host=5e:00.2,id=hostdev0,bus=root1,failover_pair_id=net1
```
```
failover_pair_id
```
 references the id of the virtio-net standby device.
