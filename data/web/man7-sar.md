---
  ...
  "description": "sar reference (system activity reporting)",
  "license": null,
  "collected_at": "2025-12-15T17:15:21.873957+00:00"
}
                ---
...
OPTIONS          top
```
-A     This is equivalent to specifying -bBdFHISvwWy -m ALL -n ALL-q ALL -r ALL -u ALL.  This option also implies specifying
       ...
       --dev=dev_list
              ...
              device names.
       -e [ hh:mm[:ss] ]-e [ seconds_since_the_epoch]
       ...
       -m { keyword[,...] | ALL }
              ...
              status Charging status of the battery: â (full), â
                     (charging), â (not charging), â (discharging), ?
                     (unknown).
       ...
       -s [ hh:mm[:ss] ]-s [ seconds_since_the_epoch]
...
FILES          top
```
/var/log/sa/saDD/var/log/sa/saYYYYMMDD
...
sadc(8), sa1(8), sa2(8), sadf(1), sysstat(5), pidstat(1),
       mpstat(1), iostat(1), vmstat(8)https://github.com/sysstat/sysstathttps://sysstat.github.io/
```
COLOPHON          top
```
