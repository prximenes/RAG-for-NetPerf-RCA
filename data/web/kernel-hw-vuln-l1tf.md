---
                {
  "source": "web",
  "label": "kernel-hw-vuln-l1tf",
  "url": "https://docs.kernel.org/admin-guide/hw-vuln/l1tf.html",
  "description": "Kernel guidance for L1TF mitigation (relevant to virtualization/security trade-offs)",
  "license": null,
  "collected_at": "2025-12-15T17:15:24.218864+00:00"
}
                ---
...
vulnerability file in sysfs. See L1TF system information.
Related CVEs¶
...
at the end of this document. See Default mitigations.
...
line and sysfs control files. See Mitigation control on the kernel command line
and Mitigation control for KVM - module parameter.
...
sysfs control files. See Mitigation control on the kernel command line and
Mitigation control for KVM - module parameter.
...
Mitigation control on the kernel command line and Mitigation control for KVM - module parameter.
...
time with the matching sysfs control files. See 4. SMT control,
Mitigation control on the kernel command line and
Mitigation control for KVM - module parameter.
- Disabling EPT:
